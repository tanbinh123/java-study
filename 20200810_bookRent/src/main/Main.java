...
public class Main {
	...
	public static void main(String[] args) {
		...
		ArrayList<info_dto> InfoArr = new ArrayList<>();
		...
		info_dao memberinfoDao = new info_dao();
		...
		do {
			try {
				...
				System.out.println("║회원 대여 정보 ---[5]     도서 정보--------[6]║");
				...
				if (workGubun == 1) {//회원관리
					...
					do {
						...
						try {
							...
							book_no = book_no.toUpperCase();
							bookArr = bookDao.selectDBId(book_no);
							if (bookArr.get(0).getRent_gubun().equals("n")) {
							...
							} else if (bookArr.get(0).getRent_gubun().equals("y")) {
								System.out.println("이미 반납 완료 된 책입니다.");
								bookExist = 1;
							}
						} catch (Exception e) {
					...
					do {
						try {
							...
							System.out.println("도서 대여 내역 조회[1] 종료[0]");
							memberRentHistory = sc.nextInt();
							if (memberRentHistory == 1) {
								System.out.println("회원 아이디 입력 : ");
								String memberId = sc.next();
								memberId = memberId.toUpperCase();
								InfoArr = memberinfoDao.selectDB(1, memberId);
								if (InfoArr.size() != 0) {
									System.out.println("║=================================================║");
									System.out.println("" + "║       ______                    _  _            ║\r\n"
											+ "║       | ___ \\                  | || |           ║\r\n"
											...
											+ "║       \\_| \\_| \\___||___/ \\__,_||_| \\__|         ║");
									System.out.println("║=================================================║");
									System.out.println("║ID\t회원이름\t책제목\t저자\t출판사\t대여기간    ║");
									System.out.println("║=================================================║");

									for (int i = 0; i < InfoArr.size(); i++) {
										System.out.print("║" + InfoArr.get(i).getMemberId() + "\t");
										System.out.print(InfoArr.get(i).getMemberName() + "\t");
										System.out.print(InfoArr.get(i).getBookName() + "\t");
										System.out.print(InfoArr.get(i).getBookWriter() + "\t");
										System.out.print(InfoArr.get(i).getBookPublisher() + "\t");
										System.out.print(InfoArr.get(i).getRentDay() + "║\n");
									}
									System.out.println("║=================================================║");
					...
					do {
						try {
							...
							if (memberRentHistory == 1) {
								...
								String memberId = sc.next();
								memberId = memberId.toUpperCase();
								InfoArr = memberinfoDao.selectDB(2, memberId);
								if (InfoArr.size() != 0) {
									System.out.println("║=================================================║");
									System.out.println("" + "║       ______                    _  _            ║\r\n"
											+ "║       | ___ \\                  | || |           ║\r\n"
									...
									System.out.println("책 번호를 다시 입력해주세요");
								}
							} else if (memberRentHistory == 0) {
								workGubun = 0;
								infoKeep = 0;
