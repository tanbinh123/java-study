...
location.href="/component/notice/notice_r.jsp";
<% }else if(whoamiPage.equals("news")){;%>
location.href="/component/news/news_r.jsp";
<% }else if(whoamiPage.equals("free")){;%>
location.href="/component/free/free_r.jsp";
<% }else if(whoamiPage.equals("qna")){;%>
location.href="/component/qna/qna_r.jsp";
<%}%>
</script>
</head>
<body>
