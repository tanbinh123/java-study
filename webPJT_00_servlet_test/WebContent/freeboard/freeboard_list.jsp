...
<%
	ArrayList<Freeboard_dto> arr = 
				(ArrayList<Freeboard_dto>)request.getAttribute("t_arr");
...
/*
	...
	ArrayList<Freeboard_dto> arr = dao.getFreeboardList(select, search);
...
<%				
				...
				if(session_level.equals("top") || !session_id.equals(null)) { %>
