...
function goDelete(){
	...
	<form name="noti">
		...
		<div class="notice">
			...
			<h2><span><i class="fas fa-edit"></i> FAQ	-View</span></h2>	
			</div>
					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<th><label for="sort">중요도</label></th>
								<td><%=dto.getSort()%></td>
							...
							<tr>
								...
								<td colspan="5"><textarea type="cont" name="cont" id="cont" class="contView" readonly><%=dto.getAnswer()%>
								</textarea>
							</tr>
								<tr>
								<th>등록자</th>
