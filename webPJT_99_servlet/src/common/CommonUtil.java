...
//    	                          "0013"
	...
	// 페이지css
	public static String pageListPostCSS(int current_page,int totalpage,int pagenumber){
...
//		pagenumber = 2;   //한 화면의 페이지 인덱스수
	...
	// 페이지
	public static String pageListPost(int current_page,int totalpage,int pagenumber){
//		int pagenumber;    //화면에 보여질 페이지 인덱스수
		int startpage;     //화면에 보여질 시작 페이지 번호
		int endpage;       //화면에 보여질 마지막 페이지 번호
		int curpage;       //이동하고자 하는 페이지 번호
