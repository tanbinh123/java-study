...
<script type="text/javascript">
	...
	function goPage(page){
		...
		<div id="b_right">
			...
			<form name="noti">
				<div> 
					<p class="leftBox">총게시글 : <%=dtos.size()%> 건</p>			
					<p class="select_box">
...
%> 		
					<tr>
						...
						<td class="t_center"><a href="notice_view.jsp?t_no=<%=dtos.get(k).getNo()%>"><%=dtos.get(k).getTitle()%></a></td>
						<td>
...
<%	} %> 
			...
			<div class="paging">
<%
//			url = "notice_list.jsp?t_select="+select+"&t_search="+search;		
