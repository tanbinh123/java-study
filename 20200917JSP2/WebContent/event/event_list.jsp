		...
		<div class="search_wrap">
			...
			<form name="board">
				<div class="search_group">
					...
					<button onclick="search()" class="btn_search"><i class="fa fa-search"></i><span class="sr-only">검색버튼</span></button>
				</div>
			</form>
		</div>
	</div>
		...
		<table class="board_table">
			...
			<thead>
				...
				<tr>
					...
					<td class="title"><a href="event_view.jsp?t_event_no=<%=arr.get(i).getNo()%>"><%=arr.get(i).getTitle()%></a></td>
