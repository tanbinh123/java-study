...
<script>
	function goSave(){
		...
		if(!checkEmpty(write.t_answer, "제목 입력!")) return;
		write.method = "post";
		write.action = "/DBFaqWriteSave";
		write.submit();
	}
</script>		
		<!--  header end -->
					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td colspan="3"><input type="text" name="t_question" id="title" class="title" placeholder="제목을 입력해주세요" maxlength="50"></td>
							</tr>
							
							<tr>
								<th><label for="cont">질문 답변</label></th>
								<td colspan="3"><textarea type="cont" name="t_answer" id="cont" class="cont" placeholder="내용을 입력해주세요" maxlength="1000"></textarea>
							</tr>
							<tr>
								<th>중요도</th>
