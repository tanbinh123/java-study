					...
					<fieldset>
						...
						<table class="table">
							...
							<tr>
								...
								<td colspan="3"><input type="text" name="t_title" value="${t_dto.getTitle }" id="title" class="title"></td>
							</tr>
							
							<tr>
								<th><label for="cont">내용</label></th>
								<td colspan="3"><textarea type="cont" name="t_content" id="cont" class="cont">${t_dto.getContent }</textarea>
							</tr>

							<tr>
								<th>등록자</th>
								<td style="text-align:left">${t_dto.getReg_name }</td>
								<th>등록일자</th>
								<td style="text-align:left">${t_dto.getReg_date }</td>
							</tr>
							<tr>
								<td colspan="4">
