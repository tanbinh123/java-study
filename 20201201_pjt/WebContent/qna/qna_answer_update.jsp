...
<script>
	...
	<form name="qna">
		...
		<div class="notice">
			...
			<h2><span><i class="fas fa-edit"></i> QandA-Answer Update</span></h2>	
			</div>
					...
					<fieldset>
						<table class="table">
							...
							<tr>
								...
								<td colspan="3"><textarea name="t_answer" id="cont" autofocus='autofocus' class="cont"><%=dto.getAnswer()%></textarea>
							</tr>
							
							<tr>
								<td colspan="4">
								<input type="button" onclick="history.back();" value="뒤로" class="btn">
								<input type="button" onclick="goAnswerUpdate()" value="답변수정저장" class="btn">
								</td>
							</tr>
